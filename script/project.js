...
function getData(container, Getdata) {
  ...
  project.open('GET', 'controller/projectScript.php?task=' + Getdata);
  project.send();
  project.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      let response = JSON.parse(this.responseText);
      let datas = response.getData;
...
getData(schoolContainer, 'school');

const buttonProject = document.querySelectorAll('.project-btn');
